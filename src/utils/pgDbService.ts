 ...
 * 3) when running development or the demo from within a docker container, the host cannot be localhost,
 *    as a bridge network in docker does not expose the localhost to individual containers
